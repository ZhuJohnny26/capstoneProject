...
#' Monk's Problems Data Set (Problem 1 Test Set Subset)
#'
#' The test set for problem 1 of the Monk's Problems Data Set,
#' excluding instances from the training set. Available from the
#' UCI Machine Learning Repository.
#'
#' @source \url{https://archive.ics.uci.edu/ml/datasets/MONK's+Problems}
#' @format A data frame with 308 rows and 8 columns:
#' \describe{
#'   \item{label}{The class label}
#'   \item{a1}{Attribute 1}
#'   \item{a2}{Attribute 2}
